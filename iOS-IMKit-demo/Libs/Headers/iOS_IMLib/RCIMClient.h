 ...
 *  初始化 SDK。
 *
 *  @param appKey       开发者平台(<a
 *src="https://developer.rongcloud.cn">developer.rongcloud.cn</>)申请的应用 Id。
 ...
 *  @param targetId         目标 Id。根据不同的 conversationType，可能是聊天
 *Id、讨论组 Id、群组 Id。
 *  @param oldestMessageId  最后一条消息的 Id，获取此消息之前的 count
 *条消息；如果传入 -1，则从最新一条消息开始获取。
 *  @param count            要获取的消息数量。
 *
...
- (void)getDiscussion:(NSString *)discussionId
             delegate:(id<RCGetDiscussionDelegate>)delegate
               object:(id)userData;
...
- (void)createDiscussion:(NSString *)name
              userIdList:(NSArray *)userIdList
                delegate:(id<RCCreateDiscussionDelegate>)delegate
                  object:(id)userData;
...
- (void)removeMemberFromDiscussion:(NSString *)discussionId
                        ...
                        completion:
                            (void (^)(RCDiscussion *discussion))completion
                             error:(void (^)(RCErrorCode status))error;
...
/**
 *  发送消息。
 *  @warning                此API目前存在bug，请使用@method
 *sendMessage:targetId:content:content:delegate:object
 *  @param targetId         目标 Id。根据不同的 conversationType，可能是聊天
 *Id、讨论组 Id、群组 Id 或聊天室 Id。
 *  @param conversationType 会话类型。
 *  @param content          消息内容。
...
- (RCMessage *)sendMessage:(RCConversationType)conversationType
                ...
                completion:(void (^)(RCErrorCode status,
                                     long messageId))completion
                  progress:(void (^)(int iProgress, long messageId))progress
                     error:(void (^)(int nErrorCode, long messageId))error;
 ...
 *  @return 发送的通知消息实体。
 */
- (RCMessage *)sendNotification:(RCConversationType)conversationType
                       targetId:(NSString *)targetId
                        content:(RCNotificationMessage *)content
                       delegate:(id<RCSendMessageDelegate>)delegate
                         object:(id)userData;
 ...
 *  @return 发送的状态消息实体。
 */
- (RCMessage *)sendStatus:(RCConversationType)conversationType
                 targetId:(NSString *)targetId
                  content:(RCStatusMessage *)content
                 delegate:(id<RCSendMessageDelegate>)delegate
                   object:(id)userData;
 ...
 *  @param userData         用户自定义数据，该值会在 delegate 中返回。
 */
- (void)downloadMedia:(RCConversationType)conversationType
             targetId:(NSString *)targetId
            mediaType:(RCMediaType)mediaType
             imageUrl:(NSString *)imageUrl
             delegate:(id<RCDownloadMediaDelegate>)delegate
               object:(id)userData;
...
getConversationNotificationStatus:(RCConversationType)conversationType
                         targetId:(NSString *)targetId
                       completion:
                           (void (^)(RCConversationNotificationStatus nStatus))
                               completion
                            error:(void (^)(RCErrorCode status))error;
...
- (void)getUserInfo:(NSString *)userId
           delegate:(id<RCGetUserInfoDelegate>)delegate
             object:(id)userData;
 ...
 *  @return 当前连接用户的信息。
 */
@property(NS_NONATOMIC_IOSONLY, getter=getCurrentUserInfo, readonly, strong)
 ...
 *  @param userData 用户自定义数据，该值会在 delegate 中返回。
 */
- (void)setReceiveMessageDelegate:(id<RCReceiveMessageDelegate>)delegate
                           object:(id)userData;
 ...
 *
 *  @param userId   用户id
 *  @param completion 获取用户黑名单状态成功。bizStatus
 *0-在黑名单，101-不在黑名单
...
- (void)setConversationNotificationQuietHours:(NSString *)startTime
                            ...
                            SuccessCompletion:(void (^)())successCompletion
                              errorCompletion:
                                  (void (^)(RCErrorCode status))errorCompletion;
/**
 *  删除push设置
 *
...
- (void)removeConversationNotificationQuietHours:(void (^)())successCompletion
                                 errorCompletion:(void (^)(RCErrorCode status))
                                                     errorCompletion;
 ...
 */
- (void)getConversationNotificationQuietHours:
            (void (^)(NSString *startTime, int spansMin))successCompletion
                              errorCompletion:
                                  (void (^)(RCErrorCode status))errorCompletion;
 ...
 *  @param successCompletion successCompletion description
 *  @param errorCompletion   errorCompletion description
 */
...
// */
//- (void)getUserData:(void (^)(RCUserData *userData))completion
//              error:(void (^)(RCErrorCode status))error;
